...
export const ProviderKind = Schema.Literals(["codex", "claudeCode", "cursor", "copilot"]);
...
// Provider start options schemas (defined here to avoid circular dependency with provider.ts)
